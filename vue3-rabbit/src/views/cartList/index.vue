...
const changeCheckbox = (i, selected) => {
    ...
    //stroe cartList 数组  无法摘掉要修改谁的选中状态
    //除了selected在补充一个筛选的参数-skuId
                ...
                <table>
                    <thead>
                        <tr>
                            <th width="120">
                                <!-- 全选isAll决定全选状态 -->
                                <el-checkbox :model-value="cartStore.isAll" @change="changeAllCheck" />
                            </th>
                        ...
                        <tr v-for="i in cartStore.cartList" :key="i.id">
                            <td>
                                <el-checkbox :model-value="i.selected"
                                    @change="(selected) => changeCheckbox(i, selected)" />
                            </td>
                            <td>
                                <div class="goods">
